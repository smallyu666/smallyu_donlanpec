...
def calculate_heat_exchanger_strength(product_id):
    ...
    futou_falan = {
        ...
        "B型钩圈名义厚度": "50", #无
        "B型钩圈颈部厚度": "30", #无
        "壳体圆筒名义内径": "1000", #壳程公称直径
        "球冠形封头预设厚度1": "0", #球冠形封头
        "球冠形封头预设厚度2": "10",#球冠形封头
        "球冠形封头预设厚度3": "20",#球冠形封头
        # "外头盖内径距浮头法兰和钩圈外径最小距离": "10", #无
        # "外头盖圆筒内径递增值": "5",#无
        "浮动管板名义厚度": "10",#无
        "浮动管板名义外径": "990", #无
        "公称直径": "1000", #管程
        ...
        "覆层位置": "双侧", #无 #钩圈
        "螺栓中心圆直径": "2013", #无
        "螺栓材料牌号": "35CrMo", #螺柱（浮头法兰）
        "螺栓公称直径": "M20", #无
        "螺栓数量": "76", #无
        "螺栓根径": "0", #无
        # "垫片序号": "1", #无
        "垫片材料牌号": "复合柔性石墨波齿金属板(不锈钢)", #浮头垫片
        "m": "3",#浮头垫片
        "y": "50",#浮头垫片
        "垫片厚度": "3",#浮头垫片
        "分程隔板与垫片接触面面积": "0", #无
        "垫片实际密封宽度": "0", #无
        "垫片代号": "2.1", #无 #布管，管程分程形式
        "隔条位置尺寸": "0", #布管，隔条位置尺寸
    ...
    waitougai_falan = {
        ...
        "焊缝长度": "0", #无
        "焊缝深度": "0", #无
        "法兰种类": "整体法兰2", #外头盖法兰 法兰类型
        "公称直径管前左": "1000", #壳程
        "公称直径壳后右": "1200", #壳程 #外头盖圆筒内径
        "对接元件管前左材料类型": "板材", #壳体圆筒
        "对接元件壳后右材料类型": "板材", #外头盖圆筒
        "对接元件管前左材料牌号": "Q345R", #壳体圆筒
        "对接元件壳后右材料牌号": "Q345R", #外头盖圆筒
        "是否带分程隔板管前左": "是", #无
        "是否带分程隔板壳后右": "是", #无
        "法兰类型管前左": "整体法兰2", #壳体法兰 #外头盖侧法兰
        "法兰材料类型管前左": "",  #壳体法兰 #外头盖侧法兰
        "法兰材料牌号管前左": "", #体法兰 #外头盖侧法兰
        "法兰材料腐蚀裕量管前左": "3", #壳程
        "法兰类型壳后右": "整体法兰2", #外头盖法兰
        "法兰材料类型壳后右": "", #外头盖法兰
        "法兰材料牌号壳后右": "", #外头盖法兰
        "法兰材料腐蚀裕量壳后右": "3", #壳程
        "覆层厚度管前左": "0", #壳体法兰 #外头盖侧法兰
        "覆层厚度壳后右": "0", #外头盖法兰
        "对接元件覆层厚度管前左": "1.5", #壳体圆筒
        "对接元件覆层厚度壳后右": "1.6", #外头盖圆筒
        "平盖序号": "9", #无
        "平盖直径": "1000", #壳程公称直径
        "纵向焊接接头系数": "1", #壳程
        "是否为圆形平盖": "是", #无
        ...
        "平盖材料腐蚀裕量": "0.1",  #无
        "平盖名义厚度": "96",  #无
        "垫片名义外径": "0", #外头盖垫片，垫片名义外径D2n
        "垫片名义内径": "0",#外头盖垫片，垫片名义内径D1n
        "螺栓中心圆直径": "1200",  #无
        "螺栓材料牌号": "35CrMo", #螺柱（外头盖法兰）
        "螺栓公称直径": "M16", #无
        "螺栓数量": "60", #无
        "螺栓根径": "0", #无
        # "垫片序号": "1", #无
        "垫片材料牌号": "复合柔性石墨波齿金属板(不锈钢)", #外头盖垫片
        "m": "3", #外头盖垫片，垫片系数m
        "y": "50", #外头盖垫片，垫片比压力y
        "垫片厚度": "3", #外头盖垫片
        "垫片有效外径": "0",
    ...
    cursor.execute("""
            SELECT 参数值
            FROM 产品设计活动表_元件附加参数表
            WHERE 产品ID = %s AND 元件名称 = '外头盖圆筒' AND 参数名称 = '公称直径'
        """, (product_id,))
    row = cursor.fetchone()
    val = row["参数值"] if row and row["参数值"] not in (None, "", "None") else "4.5"
    if str(val) == "程序推荐":
        ...
        waitougai_falan["公称直径壳后右"] = str(param_map["公称直径*"].get("壳程数值", ""))
    else:
        waitougai_falan["公称直径壳后右"] = str(val)

    # === 获取管箱垫片的垫片厚度 ===
    cursor.execute("""
        SELECT 参数值
        FROM 产品设计活动表_元件附加参数表
        WHERE 产品ID = %s AND 元件名称 = '外头盖垫片' AND 参数名称 = '垫片厚度'
    """, (product_id,))
    row = cursor.fetchone()
    val = row["参数值"] if row and row["参数值"] not in (None, "", "None") else "4.5"
    waitougai_falan["垫片厚度"] = str(val)
    # 查询浮头垫片的压紧面形状
    # cursor.execute("""
    #     SELECT 参数值
    #     FROM 产品设计活动表_元件附加参数表
    ...
    # row = cursor.fetchone()
    # if row:
    #     waitougai_falan["法兰种类"] = safe_str(row.get("参数值"))
    ...
    # 公称直径（管程）
    if "公称直径*" in param_map:
        waitougai_falan["圆筒名义外径"] = str(param_map["公称直径*"].get("管程数值", ""))
        waitougai_falan["圆筒名义内径"] = str(param_map["公称直径*"].get("壳程数值", ""))
    ...
    row = cursor.fetchone()
    if row:
        waitougai_falan["压紧面形状序号"] = safe_str(row.get("参数值"))
    ...
    for row in rows:
        ...
        if name in param_map2:
            ...
            if name in ("轴向拉伸载荷", "附加弯矩") and val == "0":
                val = "0"
            waitougai_falan[param_map2[name]] = val
    cursor.execute("""
        SELECT 参数名称, 壳程数值, 管程数值
        FROM 产品设计活动表_设计数据表
        WHERE 产品ID = %s
    ...
    # ========== 液柱静压力 和 介质密度 ==========
    if "液柱静压力" in param_map:
        waitougai_falan["壳程液柱静压力"] = safe_str(param_map["液柱静压力"].get("壳程数值"))
        waitougai_falan["管程液柱静压力"] = safe_str(param_map["液柱静压力"].get("管程数值"))
    if "介质密度" in param_map:
        waitougai_falan["壳程液柱密度"] = safe_str(param_map["介质密度"].get("壳程数值"))
        waitougai_falan["管程液柱密度"] = safe_str(param_map["介质密度"].get("管程数值"))
    cursor.execute("""
                SELECT 参数名称, 参数值
                FROM 产品设计活动表_元件附加参数表
                WHERE 产品ID = %s AND 元件名称 = '浮动管板'
    ...
    waitougai_falan["分程隔板槽宽度"] = row_map.get("分程隔板槽宽", "0")
    cursor.execute("""
            SELECT 参数名称, 壳程数值, 管程数值
            FROM 产品设计活动表_设计数据表
            WHERE 产品ID = %s
    ...
    if media_parts:
        waitougai_falan["介质情况"] = "/".join(media_parts)
    ...
    waitougai_falan["法兰材料类型管前左"] = row_map.get("材料类型", "0")
    waitougai_falan["法兰材料牌号管前左"] = row_map.get("材料牌号", "0")
    cursor.execute("""
                SELECT 参数名称, 参数值
                FROM 产品设计活动表_元件附加参数表
                WHERE 产品ID = %s AND 元件名称 = '外头盖侧法兰'
            """, (product_id,))
    rows = cursor.fetchall()
    row_map = {row["参数名称"].strip(): safe_str(row["参数值"]) for row in rows}

    waitougai_falan["法兰材料类型壳后右"] = row_map.get("材料类型", "0")
    waitougai_falan["法兰材料牌号壳后右"] = row_map.get("材料牌号", "0")
    ...
    waitougai_falan["对接元件壳后右材料类型"] = row_map.get("材料类型", "0")
    waitougai_falan["对接元件壳后右材料牌号"] = row_map.get("材料牌号", "0")
    ...
    waitougai_falan["对接元件管前左材料类型"] = row_map.get("材料类型", "0")
    waitougai_falan["对接元件管前左材料牌号"] = row_map.get("材料牌号", "0")
    ...
    waitougai_falan["圆筒材料类型"] = row_map.get("材料类型", "0")
    waitougai_falan["圆筒材料牌号"] = row_map.get("材料牌号", "0")
    # === 管箱圆筒 ===
    cursor.execute("""
               SELECT 参数名称, 参数值
               FROM 产品设计活动表_元件附加参数表
    ...
    if gx_data.get("是否添加覆层") == "是":
        waitougai_falan["对接元件覆层厚度管前左"] = gx_data.get("覆层厚度", "0")
        # guanxiang_falan["对接元件覆层复合方式管前左"] = gx_data.get("覆层成型工艺", "")
    else:
        waitougai_falan["对接元件覆层厚度管前左"] = "0"
    ...
    if qt_data.get("是否添加覆层") == "是":
        waitougai_falan["对接元件覆层厚度壳后右"] = qt_data.get("覆层厚度", "0")
        # guanxiang_falan["对接元件覆层复合方式壳后右"] = qt_data.get("覆层成型工艺", "")
    else:
        waitougai_falan["对接元件覆层厚度壳后右"] = "0"
    ...
    if qt_data.get("是否添加覆层") == "是":
        waitougai_falan["覆层厚度壳后右"] = qt_data.get("覆层厚度", "0")
        # guanxiang_falan["对接元件覆层复合方式壳后右"] = qt_data.get("覆层成型工艺", "")
    else:
        waitougai_falan["覆层厚度壳后右"] = "0"
    cursor.execute("""
                   SELECT 参数名称, 参数值
                   FROM 产品设计活动表_元件附加参数表
                   WHERE 产品ID = %s AND 元件名称 = '外头盖侧法兰'
    ...
    if qt_data.get("是否添加覆层") == "是":
        waitougai_falan["覆层厚度管前左"] = qt_data.get("覆层厚度", "0")
        # guanxiang_falan["对接元件覆层复合方式壳后右"] = qt_data.get("覆层成型工艺", "")
    else:
        waitougai_falan["覆层厚度管前左"] = "0"
    try:
        conn = pymysql.connect(
            host="localhost", user="root", password="123456",
            database="产品设计活动库", charset="utf8mb4", cursorclass=pymysql.cursors.DictCursor
    ...
    cursor.execute("""
        ...
        """, (product_id,))
    row = cursor.fetchone()
    waitougai_falan["平盖直径"] = safe_str(row["壳程数值"]) if row else "0"
    ...
    row = cursor.fetchone()
    if row:
        waitougai_falan["法兰名义内径"] = safe_str(row.get("壳程数值"))
        waitougai_falan["法兰名义外径"] = safe_str(row.get("管程数值"))
    ...
    if rows:
        params = {row.get("参数名称"): safe_str(row.get("参数值")) for row in rows}
        waitougai_falan["垫片名义外径"] = params.get("垫片名义外径D2n", "")
        if waitougai_falan["垫片名义外径"] in ("程序推荐", ""):
            waitougai_falan["垫片名义外径"] = "0"

        waitougai_falan["垫片名义内径"] = params.get("垫片名义内径D1n", "")
        if waitougai_falan["垫片名义内径"] in ("程序推荐", ""):
            waitougai_falan["垫片名义内径"] = "0"
    ...
    for name in ["材料类型", "材料牌号"]:
        if name in falan_params:
            waitougai_falan[f"法兰{name}"] = safe_str(falan_params[name])
    ...
    for field_name, key in [("液柱静压力", "液柱静压力")]:
        if key in param_map:
            waitougai_falan[f"壳程{field_name}"] = safe_str(param_map[key].get("壳程数值"))
            waitougai_falan[f"管程{field_name}"] = safe_str(param_map[key].get("管程数值"))

    # 设计参数（sheji_param）
    sheji_param = {
        "法兰材料腐蚀裕量": ("腐蚀裕量*", "壳程数值"),
        "法兰材料腐蚀裕量管前左": ("腐蚀裕量*", "壳程数值"),
    ...
    for field, (param, side) in sheji_param.items():
        ...
        waitougai_falan[field] = safe_str(val)
    ...
    yuanjian_param = {
        ...
        ("外头盖法兰", "附加弯矩"): "外力矩",
        # ("外头盖法兰", "法兰类型"): "法兰类型壳后右",
        ("外头盖法兰", "材料类型"): "法兰材料类型壳后右",
        ("外头盖法兰", "材料牌号"): "法兰材料牌号壳后右",
        # ("外头盖侧法兰", "覆层厚度"): "覆层厚度壳后右",
        ("外头盖法兰", "覆层厚度"): "覆层厚度",
        ("壳体圆筒", "材料类型"): "圆筒材料类型",
        ("壳体圆筒", "材料牌号"): "圆筒材料牌号",
        # ("外头盖侧法兰", "法兰类型"): "法兰类型管前左",
        ("外头盖侧法兰", "材料类型"): "法兰材料类型管前左",
        ("外头盖侧法兰", "材料牌号"): "法兰材料牌号管前左",
        # ("壳体平盖", "平盖类型"): "平盖序号",
        ("螺柱（外头盖法兰）", "材料牌号"): "螺栓材料牌号",
        ("外头盖垫片", "垫片材料"): "垫片材料牌号",
        ("外头盖垫片", "垫片标准"): "垫片标准号",
    ...
    for (comp, param), field in yuanjian_param.items():
        ...
        if field == "y":
            try:
                ...
                val = "50"
        waitougai_falan[field] = apply_special_defaults(field, val)
    waitougaice_falan = {
        "换热器型号": "BEU",
        "壳程液柱密度": "1", #壳程液柱密度
        "管程液柱密度": "1", #管程液柱密度
    ...
    # 公称直径（管程）
    if "公称直径*" in param_map:
        waitougaice_falan["圆筒名义外径"] = str(param_map["公称直径*"].get("管程数值", ""))
        waitougaice_falan["圆筒名义内径"] = str(param_map["公称直径*"].get("壳程数值", ""))
    # 查询浮头垫片的压紧面形状
    cursor.execute("""
        SELECT 参数值
        FROM 产品设计活动表_元件附加参数表
    ...
    row = cursor.fetchone()
    if row:
        waitougaice_falan["压紧面形状序号"] = safe_str(row.get("参数值"))
    # === 获取管箱垫片的垫片厚度 ===
    cursor.execute("""
        SELECT 参数值
        FROM 产品设计活动表_元件附加参数表
    ...
    # ========== 液柱静压力 和 介质密度 ==========
    if "液柱静压力" in param_map:
        waitougaice_falan["壳程液柱静压力"] = safe_str(param_map["液柱静压力"].get("壳程数值"))
        waitougaice_falan["管程液柱静压力"] = safe_str(param_map["液柱静压力"].get("管程数值"))
    if "介质密度" in param_map:
        waitougaice_falan["壳程液柱密度"] = safe_str(param_map["介质密度"].get("壳程数值"))
        waitougaice_falan["管程液柱密度"] = safe_str(param_map["介质密度"].get("管程数值"))
    cursor.execute("""
                SELECT 参数名称, 参数值
                FROM 产品设计活动表_元件附加参数表
                WHERE 产品ID = %s AND 元件名称 = '浮动管板'
    ...
    waitougaice_falan["分程隔板槽宽度"] = row_map.get("分程隔板槽宽", "0")
    cursor.execute("""
            SELECT 参数名称, 壳程数值, 管程数值
            FROM 产品设计活动表_设计数据表
            WHERE 产品ID = %s
    ...
    if media_parts:
        waitougaice_falan["介质情况"] = "/".join(media_parts)
    ...
    waitougaice_falan["法兰材料类型管前左"] = row_map.get("材料类型", "0")
    waitougaice_falan["法兰材料牌号管前左"] = row_map.get("材料牌号", "0")
    cursor.execute("""
                SELECT 参数名称, 参数值
                FROM 产品设计活动表_元件附加参数表
                WHERE 产品ID = %s AND 元件名称 = '外头盖侧法兰'
    ...
    waitougaice_falan["法兰材料类型壳后右"] = row_map.get("材料类型", "0")
    waitougaice_falan["法兰材料牌号壳后右"] = row_map.get("材料牌号", "0")
    # === 获取“管箱圆筒”对接元件材料信息 ===
    cursor.execute("""
                SELECT 参数名称, 参数值
                FROM 产品设计活动表_元件附加参数表
    ...
    waitougaice_falan["对接元件管前左材料类型"] = row_map.get("材料类型", "0")
    waitougaice_falan["对接元件管前左材料牌号"] = row_map.get("材料牌号", "0")
    ...
    waitougaice_falan["对接元件壳后右材料类型"] = row_map.get("材料类型", "0")
    waitougaice_falan["对接元件壳后右材料牌号"] = row_map.get("材料牌号", "0")
    ...
    # guangxiang_pinggai["圆筒名义内径"] = row_map.get("内径", "0")
    # guangxiang_pinggai["圆筒名义外径"] = row_map.get("外径", "0")
    waitougaice_falan["圆筒材料类型"] = row_map.get("材料类型", "0")
    waitougaice_falan["圆筒材料牌号"] = row_map.get("材料牌号", "0")
    # === 管箱圆筒 ===
    cursor.execute("""
               SELECT 参数名称, 参数值
               FROM 产品设计活动表_元件附加参数表
    ...
    if gx_data.get("是否添加覆层") == "是":
        waitougaice_falan["对接元件覆层厚度管前左"] = gx_data.get("覆层厚度", "0")
        # guanxiang_falan["对接元件覆层复合方式管前左"] = gx_data.get("覆层成型工艺", "")
    else:
        waitougaice_falan["对接元件覆层厚度管前左"] = "0"
        # guanxiang_falan["对接元件覆层复合方式管前左"] = ""
    ...
    if qt_data.get("是否添加覆层") == "是":
        waitougaice_falan["对接元件覆层厚度壳后右"] = qt_data.get("覆层厚度", "0")
        # guanxiang_falan["对接元件覆层复合方式壳后右"] = qt_data.get("覆层成型工艺", "")
    else:
        waitougaice_falan["对接元件覆层厚度壳后右"] = "0"
        # guanxiang_falan["对接元件覆层复合方式壳后右"] = ""
    cursor.execute("""
                   SELECT 参数名称, 参数值
                   FROM 产品设计活动表_元件附加参数表
    ...
    if qt_data.get("是否添加覆层") == "是":
        waitougaice_falan["覆层厚度壳后右"] = qt_data.get("覆层厚度", "0")
        # guanxiang_falan["对接元件覆层复合方式壳后右"] = qt_data.get("覆层成型工艺", "")
    else:
        waitougaice_falan["覆层厚度壳后右"] = "0"
    cursor.execute("""
                   SELECT 参数名称, 参数值
                   FROM 产品设计活动表_元件附加参数表
                   WHERE 产品ID = %s AND 元件名称 = '外头盖侧法兰'
    ...
    if qt_data.get("是否添加覆层") == "是":
        waitougaice_falan["覆层厚度管前左"] = qt_data.get("覆层厚度", "0")
        # guanxiang_falan["对接元件覆层复合方式壳后右"] = qt_data.get("覆层成型工艺", "")
    else:
        waitougaice_falan["覆层厚度管前左"] = "0"
    try:
        conn = pymysql.connect(
            host="localhost", user="root", password="123456",
            database="产品设计活动库", charset="utf8mb4", cursorclass=pymysql.cursors.DictCursor
    ...
    waitougaice_falan["隔条位置尺寸"] = val11
    ...
    cursor.execute("""
        ...
        """, (product_id,))
    row = cursor.fetchone()
    waitougaice_falan["平盖直径"] = safe_str(row["壳程数值"]) if row else "0"
    ...
    row = cursor.fetchone()
    if row:
        waitougaice_falan["法兰名义内径"] = safe_str(row.get("壳程数值"))
        waitougaice_falan["法兰名义外径"] = safe_str(row.get("管程数值"))
    ...
    if rows:
        params = {row.get("参数名称"): safe_str(row.get("参数值")) for row in rows}
        waitougaice_falan["垫片名义外径"] = params.get("垫片名义外径D2n", "")
        if waitougaice_falan["垫片名义外径"] in ("程序推荐", ""):
            waitougaice_falan["垫片名义外径"] = "0"

        waitougaice_falan["垫片名义内径"] = params.get("垫片名义内径D1n", "")
        if waitougaice_falan["垫片名义内径"] in ("程序推荐", ""):
            waitougaice_falan["垫片名义内径"] = "0"
    ...
    for name in ["材料类型", "材料牌号"]:
        if name in falan_params:
            waitougaice_falan[f"法兰{name}"] = safe_str(falan_params[name])
    ...
    for field_name, key in [("液柱静压力", "液柱静压力")]:
        if key in param_map:
            waitougaice_falan[f"壳程{field_name}"] = safe_str(param_map[key].get("壳程数值"))
            waitougaice_falan[f"管程{field_name}"] = safe_str(param_map[key].get("管程数值"))
    ...
    for field, (param, side) in sheji_param.items():
        val = param_map.get(param, {}).get(side, "")
        waitougaice_falan[field] = safe_str(val)
    ...
    for (comp, param), field in yuanjian_param.items():
        ...
        if field == "m":
            try:
                ...
                val = "3"
        waitougaice_falan[field] = apply_special_defaults(field, val)
    ...
    guanban_a = {
        ...
        "管程腐蚀裕量": "2", #管程
        "壳程腐蚀裕量": "2",  #壳程
        "是否可以保证在任何情况下管壳程压力都能同时作用": "0", #固定管板
        ...
        "管板刚度削弱系数": "0.4",#固定管板
        "换热管材料类型": "钢管", #换热管
        "换热管材料牌号": "10(GB9948)",#换热管
        "换热管外径": "25",#换热管
        "换热管壁厚": "2", #布管
        "换热管直管段长度": "6000", #布管
        "换热管伸出管板长度": "4.5", #无
        "换热管根数": tubes_count,  #布管
        "换热管中心距": s_val, #布管
        "耐压试验温度": "20", #无
        "换热管受压失稳当量长度": "800",#无
        "内孔焊焊接接头系数": "0.85", #无
    ...
    if rows:
        params = {row.get("参数名称"): safe_str(row.get("参数值")) for row in rows}
        guanban_a["换热管外径"] = params.get("换热管外径", "")
    ...
    cursor.execute("""
        ...
        WHERE 产品ID = %s
          AND 元件名称 = '固定管板'
          AND 参数名称 IN ('管板强度削弱系数','管板刚度削弱系数')
    """, (product_id,))

    rows = cursor.fetchall()
    if rows:
        params = {row.get("参数名称"): safe_str(row.get("参数值")) for row in rows}
        guanban_a["管板强度削弱系数"] = params.get("管板强度削弱系数", "")
        guanban_a["管板刚度削弱系数"] = params.get("管板刚度削弱系数", "")

    import pymysql
    # 查询固定管板参数：是否可以保证在任何情况下管壳程压力都能同时作用
    cursor.execute("""
        SELECT 参数值
        FROM 产品设计活动表_元件附加参数表
        WHERE 产品ID = %s
          AND 元件名称 = '固定管板'
          AND 参数名称 = '是否可以保证在任何情况下管壳程压力都能同时作用'
    """, (product_id,))

    row = cursor.fetchone()
    if safe_str(row.get("参数值")) == "是":
        guanban_a["是否可以保证在任何情况下管壳程压力都能同时作用"] = "1"
    else:
        guanban_a["是否可以保证在任何情况下管壳程压力都能同时作用"] = "0"
    ...
    if fenchengxingshi:
        ...
        if fenchengxingshi == "2" or fenchengxingshi == None or fenchengxingshi == "":
    ...
    cursor.execute("""
        SELECT 参数值
        FROM 产品设计活动表_元件附加参数表
        WHERE 产品ID = %s AND 元件名称 = '换热管' AND 参数名称 = '材料类型'
    """, (product_id,))
    row = cursor.fetchone()
    ...
    cursor.execute("""
                SELECT 参数值
                FROM 产品设计活动表_元件附加参数表
                WHERE 产品ID = %s AND 元件名称 = '内导流筒' AND 参数名称 = '导流筒直边高度'
            """, (product_id,))
    row = cursor.fetchone()
    ...
    cursor.execute("""
                SELECT 参数值
                FROM 产品设计活动表_元件附加参数表
                WHERE 产品ID = %s AND 元件名称 = '内导流筒' AND 参数名称 = '倒圆半径'
            """, (product_id,))
    row = cursor.fetchone()

    tube_bundle["导流筒内部折边倒角"] = str(row["参数值"]).strip()
    ...
    # row = cursor.fetchone()
    # if row:
    #     tube_bundle["管板类型"] = str(row["管板类型"])[0]  # 取第一个字母
    ...
    row = cursor.fetchone()
    if row:
        tube_bundle["换热管伸出管板值"] = str(row["参数值"])  # 取参数值
    sql = """
               SELECT 参数值
               FROM 产品设计活动表_布管参数表
               WHERE 产品ID = %s
    ...
    row = cursor.fetchone()
    if row:
        tube_bundle["折流板切口与中心线间距"] = str(row["参数值"])  # 取参数值
    ...
    row = cursor.fetchone()
    if row:
        tube_bundle["折流板需求间距"] = str(row["参数值"])  # 取参数值
    sql = """
           SELECT 管口功能, `周向方位（°）`
           FROM 产品设计活动表_管口表
           WHERE 产品ID = %s
             AND 管口功能 IN ('壳程入口', '壳程出口')
       """
    cursor.execute(sql, (product_id,))
    rows = cursor.fetchall()

    # 2. 提取周向方位
    orientations = [row["周向方位（°）"] for row in rows if row.get("周向方位（°）") is not None]

    if len(orientations) < 2:
        print("⚠️ 未找到两个管口（壳程入口/出口），无法判定")
        layout_type = None
    else:
        layout_type = "2" if orientations[0] == orientations[1] else "1"

    tube_bundle["接管布置型式"] = layout_type
    ...
    row = cursor.fetchone()
    if row:
        raw_value = safe_str(row.get("参数值"))
        roman_to_arabic = {
            "Ⅰ": "1", "Ⅱ": "2", "Ⅲ": "3",
            "Ⅳ": "4", "Ⅴ": "5", "Ⅵ": "6"
        }
        tube_bundle["换热管材料序号"] = roman_to_arabic.get(raw_value, raw_value)

    # === 参数名和 guanban_a 键的映射 ===
    mapping = {
        "换热管壁厚 δ": "换热管壁厚",
        "换热管公称长度 LN": "换热管理论直管长度"
    }
    ...
    row = cursor.fetchone()
    if row:
        tube_bundle["导流筒厚度"] = safe_str(row.get("参数值"))
    cursor.execute("""
            SELECT 参数值
            FROM 产品设计活动表_元件附加参数表
            WHERE 产品ID = %s
    ...
    row = cursor.fetchone()
    if row:
        tube_bundle["旁路挡板厚度"] = safe_str(row.get("参数值"))
    try:
        conn = pymysql.connect(
            host="localhost", user="root", password="123456",
            database="产品设计活动库", charset="utf8mb4", cursorclass=pymysql.cursors.DictCursor
    ...
    try:
        ...
        elif tube_passes == "4.1":
            tube_bundle["水平分程隔板槽数量"] = "3"
            tube_bundle["竖直分程隔板槽数量"] = "0"
        elif tube_passes == "4.3":
            tube_bundle["水平分程隔板槽数量"] = "2"
            tube_bundle["竖直分程隔板槽数量"] = "1"
        elif tube_passes == "6.1":
            tube_bundle["水平分程隔板槽数量"] = "3"
            tube_bundle["竖直分程隔板槽数量"] = "1"
        elif tube_passes == "6.2":
            tube_bundle["水平分程隔板槽数量"] = "2"
            tube_bundle["竖直分程隔板槽数量"] = "1"
        else:
